...
CSRF_TRUSTED_ORIGINS = [
    ...
    "http://127.0.0.1:8000",
    "http://localhost:8000",
    "https://my-djangopython-project.onrender.com",
    "https://my-djangopython-project-5.onrender.com",
]
...
MIDDLEWARE = [
    ...
    'work.middleware.UserSessionSyncMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'work.context_processors.user_country_context',
            ],
        },
    },
]
